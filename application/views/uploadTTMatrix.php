  ...
  <div class="form-group">
    ...
    <input type="password" name="FPwd" class="form-control" id="FPwd" pattern=".{8,15}" oninvalid="this.setCustomValidity('Please enter 8-15 digit password ')" oninput="setCustomValidity('')" required>
        ...
        <?php $attr = array('name' => 'form2','method' => 'POST','id' => 'csv');
              echo form_open('Ctrl_admin/uploadTimetable',$attr); ?>
        <center><div class="container">
        <div class="col-lg-6 col-sm-6 col-12">
            <div class="input-group">
                <label class="input-group-btn">
                    <span class="btn btn-primary">
                        Browse&hellip; <input type="file" name="timetable" style="display: none;" required>
                    </span>
                </label>
                <input type="text" name="uploadcsv" value="Upload csv here" class="form-control" readonly>
            </div>
<input class="button new btn-lg round" style="width:80%;background-color: #83919c;" align="center" type="submit"><span></span><b style="color: #fafafa;">Add</b></button>
        </div></center>
        </form>
        <?php 
			if(isset($_POST['success']))
